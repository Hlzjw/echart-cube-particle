...
import * as symbolUtil from 'echarts/lib/util/symbol';
import ECLinePath from 'echarts/lib/chart/helper/LinePath';
import * as graphic from 'echarts/lib/util/graphic';
import { enableHoverEmphasis, enterEmphasis, leaveEmphasis, SPECIAL_STATES } from 'echarts/lib/util/states';
import { getLabelStatesModels, setLabelStyle } from 'echarts/lib/label/labelStyle';
  ...
  Line.prototype._updateCommonStl = function (lineData, idx, seriesScope) {
    ...
    each(SYMBOL_CATEGORIES, function (symbolCategory) {
      ...
      if (symbol) {
        ...
        symbol.setColor(visualColor, lineStyle.innerColor);
