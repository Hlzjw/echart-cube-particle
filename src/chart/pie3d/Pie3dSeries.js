...
import { extendSeriesModel } from 'echarts/lib/export/api';
import { defaultEmphasis } from 'echarts/lib/util/model';
import LegendVisualProvider from 'echarts/lib/visual/LegendVisualProvider';
import createSeriesDataSimply from 'echarts/lib/chart/helper/createSeriesDataSimply';
import { makeSeriesEncodeForNameBased } from 'echarts/lib/data/helper/sourceHelper';
