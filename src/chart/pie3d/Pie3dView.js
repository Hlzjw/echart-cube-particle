...
PiePiece.prototype._updateLabel = function (seriesModel, data, idx, themeHighColor) {
	...
	var visualColor = data.getItemVisual(idx, 'color');
	// 如果是自定义就用自定义的颜色，否则就取色系的颜色 nts 2022.02.28
	var fontIsCustomize = seriesModel.get(['fontIsCustomize'])
	var labelOption = seriesModel.get(['label'])
	var labeColor;
...
// Pie view
var Pie3dView = ChartView.extend({
