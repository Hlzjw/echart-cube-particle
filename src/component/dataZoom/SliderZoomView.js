...
import * as throttle from 'echarts/lib/util/throttle';
import DataZoomView from 'echarts/lib/component/dataZoom/DataZoomView';
import { linearMap, asc, parsePercent } from 'echarts/lib/util/number';
import * as layout from 'echarts/lib/util/layout';
import sliderMove from 'echarts/lib/component/helper/sliderMove';
import { getAxisMainType, collectReferCoordSysModelInfo } from 'echarts/lib/component/dataZoom/helper';
...
function (_super) {
  ...
  SliderZoomView.prototype.render = function (dataZoomModel, ecModel, api, payload) {
    ...
    // 添加事件沉默
    const silent = dataZoomModel.get('silent');
    this.group.silent = silent;
