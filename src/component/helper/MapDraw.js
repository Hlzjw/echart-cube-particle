...
import RoamController from 'echarts/lib/component/helper/RoamController.js';
import * as roamHelper from 'echarts/lib/component/helper/roamHelper.js';
import { onIrrelevantElement } from 'echarts/lib/component/helper/cursorHelper.js';
import * as graphic from 'echarts/lib/util/graphic.js';
import { toggleHoverEmphasis, enableComponentHighDownFeatures, setDefaultStateProxy } from 'echarts/lib/util/states.js';
import geoSourceManager from 'echarts/lib/coord/geo/geoSourceManager.js';
import { getUID } from 'echarts/lib/util/component.js';
import { setLabelStyle, getLabelStatesModels } from 'echarts/lib/label/labelStyle.js';
import { getECData } from 'echarts/lib/util/innerStore.js';
import { createOrUpdatePatternFromDecal } from 'echarts/lib/util/decal.js';
import Displayable from 'zrender/lib/graphic/Displayable.js';
import { makeInner } from 'echarts/lib/util/model.js';
/**
    ...
    (function () {
        ...
        MapDraw.prototype.draw = function (mapOrGeoModel, ecModel, api, fromView, payload) {
            ...
            isGeo &&
                ecModel.eachComponent(
                    ...
                    function (mapSeries) {
                        ...
                        } else if (mapSeries.getHostGeoModel() === mapOrGeoModel) {
                            extraSeries.push(mapSeries);
                        }
                    }
                );
            ...
            var isVisualEncodedByVisualMap =
                data && data.getVisual('visualMeta') && data.getVisual('visualMeta').length > 0;
            var viewBuildCtx = {
                api: api,
                geo: geo,
...
function applyOptionStyleForRegion(viewBuildCtx, el, dataIndex, regionModel) {
    ...
    if (data) {
        ...
        // 条件渲染修改
        const name = data.getItemModel(dataIndex).get(['name']);

        if (viewBuildCtx.isVisualEncodedByVisualMap && style.fill) {
            normalStyle.fill = style.fill;
        }

        if (viewBuildCtx.extraSeries.length > 0) {
