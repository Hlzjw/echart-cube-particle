...
import findPointFromSeries from 'echarts/lib/component/axisPointer/findPointFromSeries';
import * as layoutUtil from 'echarts/lib/util/layout';
import Model from 'echarts/lib/model/Model';
import * as globalListener from 'echarts/lib/component/axisPointer/globalListener';
import * as axisHelper from 'echarts/lib/coord/axisHelper';
import * as axisPointerViewHelper from 'echarts/lib/component/axisPointer/viewHelper';
import { getTooltipRenderMode, preParseFinder, queryReferringComponents } from 'echarts/lib/util/model';
import ComponentView from 'echarts/lib/view/Component';
import { format as timeFormat } from 'echarts/lib/util/time'; // import { isDimensionStacked } from 'echarts/lib/data/helper/dataStackHelper';

import { getECData } from 'echarts/lib/util/innerStore';
import { shouldTooltipConfine } from 'echarts/lib/component/tooltip/helper';
import { normalizeTooltipFormatResult } from 'echarts/lib/model/mixin/dataFormat';
import { createTooltipMarkup, buildTooltipMarkup, TooltipMarkupStyleCreator } from 'echarts/lib/component/tooltip/tooltipMarkup';
import { findEventDispatcher } from 'echarts/lib/util/event';
import { throttle } from 'echarts/lib/util/throttle';
...
function (_super) {
  ...
  TooltipView.prototype._showSeriesItemTooltip = function (e, dispatcher, dispatchAction) {
    ...
    if ((tooltipTrigger != null && tooltipTrigger !== 'item') ||  ecData.dataModel) { // TODO 修改极值tooltip
      return;
    }
