...
* under the License.
*/
import { Point, Path, Polyline } from 'echarts/lib/util/graphic';
...
import { DISPLAY_STATES, SPECIAL_STATES } from 'echarts/lib/util/states';
var PI2 = Math.PI * 2;
  ...
  for (var i = 0; i < DISPLAY_STATES.length; i++) {
    ...
    if (stateModel) {
      ...
      || !retrieve2(stateShow, showNormal) // Use normal state by default if not set.
          ...
          var stateObj = isNormal ? labelLine : labelLine && labelLine.ensureState(stateName);
